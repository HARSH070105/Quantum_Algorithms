...
print(f"Initializing a {dim}x{dim} system for the 2D Chain...")
...
# --- Diagonalization ---
print("Targeting the lowest 200 energy states...")
t0 = time.time()
...
print("Converting sparse matrices to dense for expm...")
H_dense, H1_dense, H2_dense = H_sparse.toarray(), H1_sparse.toarray(), H2_sparse.toarray()

print("Simulating Time Evolution Sequence...")
...
ax1.set_title('1st Order Trotter Error ($W_1(s)$)')
ax2.set_title('2nd Order Trotter Error ($W_2(s)$)')
